package com.example.cosmosrun.services
...
import com.example.cosmosrun.other.Constants.NOTIFICATION_CHANNEL_ID
import com.example.cosmosrun.other.Constants.NOTIFICATION_CHANNEL_NAME
import com.example.cosmosrun.other.Constants.NOTIFICATION_ID
...
class TrackingService : LifecycleService() {
    ...
    //Update notification only when tracking state changes (isTracking)
        ...
        if(isTracking) {
            if(TrackingUtility.hasLocationPermissions(this)){
                val request = LocationRequest().apply{
                    ...
                    fastestInterval = SMALLEST_LOCATION_INTERVAL
    ...
    //add blank polyline for pausing
        ...
        timeRunInSeconds.observe(this, Observer {
            if(!serviceKilled) {
                val notification = curNotificationBuilder
                    .setContentText(TrackingUtility.getFormatedTimer(it * 1000L))
